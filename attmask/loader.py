...
#from icdar2017loader import icdar2017patcher
...
class ImageFolderMask(ImageFolder):
    def __init__(self, *args, patch_size, pred_ratio, pred_ratio_var, pred_aspect_ratio, 
        ...
        self.dataset = icdar2017patcher(*args, **kwargs)
        self.samples = self.dataset.patch_coords
        self.psz = patch_size
    ...
    def __getitem__(self, index):
        ...
        output, writer, page = self.dataset[index]
