...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 init_values=0, use_mean_pooling=False, masked_im_modeling=False, num_class_tokens=1):
        super().__init__()
    ...
    def forward(self, x_orig, return_all_tokens=None, mask=None, keep_ids=None, return_attention = True, **kwargs):
        
        # mim
        # if self.masked_im_modeling:
        #     assert mask is not None
        #     x = self.prepare_tokens(x_orig, mask=mask)
        # else:
